...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_АнализВыставленныхАктовИспользование");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Подсистемы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ТелеграмОповещения");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВыработкаСпециалистовИспользование");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускМобильногоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТолстогоКлиента");
	...
	// Профиль "ВКМ КадровикРасчетчик".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Родитель      = "Вкм";
	ОписаниеПрофиля.Идентификатор = "cde6a886-2640-11ef-b021-ec2e98d37cb6";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'ВКМ КадровикРасчетчик'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_БазовыеПрава");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОбслуживаниеКлиентаЧтениеПросмотр");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Подсистемы");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасчетЗарплатыДобавлениеИзменение");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ВыработкаСпециалистовИспользование");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасчетыССотрудникамиИспользование");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_РасходЗапланированныхОтпусковИспользование");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускМобильногоКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТолстогоКлиента");
